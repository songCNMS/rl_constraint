...
if __name__ == "__main__":
    ...
    for sku_name in supply_network_config.get_all_skus():
        supplier_skus = []
        ...
        _sku_base_stocks = BaseStockPolityUtility.get_base_stock(supplier_skus, time_hrz_len)
        sku_base_stocks.update(_sku_base_stocks)
    print(sku_base_stocks)
