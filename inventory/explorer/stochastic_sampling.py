...
class StochasticSampling(Exploration):
    ...
    def _get_torch_exploration_action(self, action_dist: ActionDistribution,
        ...
        # if self.last_timestep % 3000 == 0:
        #     print(explore, self.last_timestep, self.random_timesteps)
        #     if hasattr(action_dist, 'dist'):
        #         print(action_dist.dist.probs)
        #     else:
        #         for cat in action_dist.cats:
        #             print(cat.probs)
        # Apply exploration.
        if explore:
